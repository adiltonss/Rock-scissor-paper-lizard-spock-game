...
function compareHands(){
    if (player === 'scissors' && cpu === 'paper' || player === 'scissors' && cpu === 'lizard'){
       updateScore(true)
    }
    if (player === 'paper' && cpu === 'rock' || player === 'paper' && cpu === 'spock'){
       updateScore(true)
    }
    if (player === 'rock' && cpu === 'scissors' || player === 'rock' && cpu === 'lizard'){
       updateScore(true)
    }
    if (player === 'lizard' && cpu === 'paper' || player === 'lizard' && cpu === 'spock'){
       updateScore(true)
    }
    if (player === 'spock' && cpu === 'rock' || player === 'spock' && cpu === 'scissors'){
       updateScore(true)
    }
    if (cpu === 'scissors' && player === 'paper' || cpu === 'scissors' && player === 'lizard'){
       updateScore(false)
    }
    if (cpu === 'paper' && player === 'rock' || cpu === 'paper' && player === 'spock'){
       updateScore(false)
    }
    if (cpu === 'rock' && player === 'scissors' || cpu === 'rock' && player === 'lizard'){
       updateScore(false)
    }
    if (cpu === 'lizard' && player === 'paper' || cpu === 'lizard' && player === 'spock'){
       updateScore(false)
    }
    if (cpu === 'spock' && player === 'rock' || cpu === 'spock' && player === 'scissors'){
       updateScore(false)
    }
    if(player === cpu){
